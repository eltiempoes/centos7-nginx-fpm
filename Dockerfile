...
RUN rpm -Uvh https://dl.fedoraproject.org/pub/epel/epel-release-latest-7.noarch.rpm && \
    ...
    yum -y --setopt=tsflags=nodocs install php70w php70w-cli php70w-fpm php70w-gd php70w-mbstring php70w-mysql php70w-opcache php70w-pdo php70w-xml php70w-pecl-xdebug && \
    yum clean all
