...
RUN rpm -Uvh https://dl.fedoraproject.org/pub/epel/epel-release-latest-7.noarch.rpm && \
    ...
    yum -y --setopt=tsflags=nodocs install php70w php70w-cli php70w-fpm php70w-gd php70w-mbstring php70w-mysqlnd php70w-opcache php70w-pdo php70w-xml php70w-pecl-xdebug php70w-imap php70w-tidy php70w-xmlrpc php70w-soap && \
    yum clean all
